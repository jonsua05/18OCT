...
<head>
    <title>Aulas para todos| Contact</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link" href="/tas/about">Acerda de nosotros</a>
                        </li>
                               <li class="nav-item mr-lg-3 mt-lg-0 mt-3">
    ...
    <section class="contact-wthree align-w3" id="contact">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                <h4 class="w3pvt-title">Contactenos
                </h4>
                <span class="sub-title">Puedes escribir algunos datos para tu registro</span>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 contact-w3">
                        ...
                        <div class="d-flex flex-column">
                            <a href="mailto:example@email.com" class="d-block">ejemplo: info@example.com</a>
                    ...
                    <div class="col-lg-4 contact-w3 my-lg-0 my-4">
                        ...
                        <div class="d-flex flex-column">
                            <p>ejemplo : +57 6 123 7890</p>
                        </div>
                    </div>
                    <div class="col-lg-4 contact-w3">
                        <span class="fa fa-home mr-2 my-3"></span>
                        <address>Universidad Católica de Colombia. Chapinero, Bogotá, Colombia.</address>
                    </div>
                </div>
                <!-- //footer right -->
            </div>
