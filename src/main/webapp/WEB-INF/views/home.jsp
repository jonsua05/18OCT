            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li class="nav-item mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link" href="/tas/contact">Contacto</a>
                        </li>
                    </ul>
                </div>
...
<form action="/tas/logout" class="btn  ml-2 w3ls-btn" data-toggle="modal" method="post">
    ...
    <section class="single_grid_w3_main align-w3" id="about">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                <h4 class="w3pvt-title">Mision de aulas para todos
                </h4>
                ...
                <div class="col-lg-6">
                    <div class="single_grid_text">
                        <h5>Nuestro aporte
                            ...
                            Aulas para todos</h5>
                        <p>Donación de infraestructura escolar a través de internet</p>
    ...
    <div class="wthree_pvtits-services align-w3" id="services">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                <h4 class="w3pvt-title">Tipos de donación
                </h4>
    ...
    <section class="slide-banner d-flex flex-column justify-content-center align-items-center my-lg-5">
        <h5 class="text-center">Empieza a conectarte con el muendo de las donaciones</h5>
        <a href="/tas/gallery" class="btn btn-primary mt-4 wthree-link-bnr">ver mas</a>
    </section>
    <!-- //slide -->
    <!-- blog -->
    ...
    <div class="cpy-right text-center bg-theme">
        <p class="text-white">Â© 2018 AULAS PATA TODOS. Todos los derechos reservados | Diseñadp por
